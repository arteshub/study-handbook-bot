...
namespace HandbookBot.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260526021925_AddScrollAndDiscard")]
    partial class AddScrollAndDiscard
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HandbookBot.Domain.Entities.CachedQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TopicId", "Mode", "ContentHash");

                    b.ToTable("cached_questions", (string)null);
                });

            modelBuilder.Entity("HandbookBot.Domain.Entities.DiscardedQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid>("CachedQuestionId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("UserId", "CachedQuestionId")
                        .IsUnique();

                    b.ToTable("discarded_questions", (string)null);
                });

            modelBuilder.Entity("HandbookBot.Domain.Entities.ReadingPosition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("reading_positions", (string)null);
                });
            ...
            modelBuilder.Entity("HandbookBot.Domain.Entities.TestResult", b =>
                {
                    ...
                    b.Property<Guid?>("CachedQuestionId")
                        .HasColumnType("uuid")
                        .HasColumnName("cached_question_id");
